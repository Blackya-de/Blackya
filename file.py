...
button2 = Button(text ="Receive File",fg ='white', bg = 'black', relief=FLAT,width=24 ,height = 1,command = threading.Thread(target=Receive,args=(window,)).start).place(x = 800, y=80)
